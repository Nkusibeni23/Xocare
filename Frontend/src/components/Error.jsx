export default function Error() {
  return (
    <div className="h-screen w-screen bg-gray-100 flex items-center px-6">
      <div className="container flex flex-col md:flex-row items-center justify-center px-5 text-gray-700">
        <div className="max-w-md">
          ...
          <button className="p-3 border-2 rounded-lg border-black font-medium hover:bg-black hover:text-white transition-all duration-500">
            Back to homepage
          </button>
        </div>
