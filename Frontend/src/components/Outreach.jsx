      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 text-center">
        <div className="p-4">
          ...
          <p className=" text-sm lg:text-lg text-gray-700 font-medium">
            This is a custom image upload field. You can drag and drop or click
            to select an image from your computer, then it will be displayed
            here for you to review before submitting the form below. If you don
            &apos;t want any image, just leave this field blank.
          </p>
        </div>
        <div className="p-4">
          <img
          ...
          <p className=" text-sm lg:text-lg text-gray-700 font-medium">
            ...
            other fields that are in the form. In this case, there &apos;s only
            one file input so far, but you could easily add more if needed.
          </p>
        </div>
        <div className="p-4">
          <img
          ...
          <p className=" text-sm lg:text-lg text-gray-700 font-medium">
            ...
            handling the form submission. They do, however, need to have unique
            names, otherwise, they will overwrite each other.
          </p>
        </div>
      </div>
    </div>
