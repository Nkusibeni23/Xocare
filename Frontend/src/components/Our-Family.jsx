  ...
  return (
    <div className="flex flex-col max-w-screen-3xl mx-auto items-center justify-center text-center bg-white">
      <div className="py-6">
        ...
        <p className="text-gray-500 py-3 w-[450px] lg:w-[550px] text-center mx-auto">
        ...
        <button className="p-3 bg-orange-500 mt-4 rounded-lg font-semibold hover:bg-orange-600 transition-all duration-500 w-[220px] mb-3 uppercase text-white">
          Donate Now
        </button>
      </div>
    </div>
