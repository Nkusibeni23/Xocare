              ...
              <div className="w-[450px] mx-auto">
                ...
                <div className="flex justify-center gap-x-28 py-8">
                  <button
                    ...
                    className="p-2 bg-black text-white rounded-lg cursor-pointer w-[180px]"
                  >
                    Full site
                  </button>
                  <button
                    onClick={handleButton}
                    className="p-2 border-2 border-black text-black rounded-lg cursor-pointer w-[180px] hover:bg-black hover:text-white transition-all duration-500"
                  >
                    Donate
                  </button>
                </div>
            ...
            >
              <div className=" px-16">
                ...
                <div className="w-[300px]">
                  <p className="text-left text-3xl text-gray-50 font-light">
                  ...
                  <div className="flex justify-center gap-10 py-14 px-4">
                    <button
                      onClick={handleNavigation}
                      className="p-2 bg-black text-white rounded-lg cursor-pointer w-full"
                    >
                      Full site
                    </button>
                    <button
                      onClick={handleButton}
                      className="p-2 text-black rounded-lg cursor-pointer bg-white w-full hover:bg-black hover:text-white transition-all duration-500"
                    >
                      Donate
                    </button>
                  </div>
              ...
              <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 flex justify-between items-center w-[300px] text-white cursor-pointer">
                <div>
                  <FaXTwitter className="w-10 h-10" alt="Twitter" />
                </div>
                <div>
                  <FaInstagram className="w-10 h-10" />
                </div>
