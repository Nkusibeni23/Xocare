  ...
  return (
    <>
      ...
      <div className="mt-8">
        ...
        <select
          className="select select-bordered border border-gray-400 rounded-md h-[60px] bg-transparent text-gray-600 w-full hover:border-4 hover:border-gray-950 transition-all duration-500 hover:outline-none mt-2"
          required
        >
